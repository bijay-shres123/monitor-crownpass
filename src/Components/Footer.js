        ...
        <div className="container">
          <div className="row">
            <div className="col-md-5 col-sm-6">
              ...
              <span style={{fontWeight:'bold', fontColor: '#000', padding:'9px'}}>Crownpass Monitor</span>
              <br />
              <br />
              <p>
              Welcome to Crownpass Desktop Montior
            ...
            <div className="col-md-3  col-sm-12">
              ...
              <div className="text-widget">
                ...
                <span>
                  {' '}
                  <Link to="/">enquiry@crownpass.com</Link>{' '}
                </span>
                <br />
              </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="copyrights">
                © 2022 Crownpass Monitor. All Rights Reserved.
              </div>
            </div>
          </div>
        </div>
